...
if(l.rp<z.rp)return-1;return 0});a.each(N,function(l,z){a("tbody",x).append(z)})}b.gbox="#gbox_"+m;var I=false;if(b.closeOnEscape===true){b.closeOnEscape=false;I=true}p=a("<span></span>").append(p).append("<table border='0' class='EditTable' id='"+t+"_2'><tbody><tr><td colspan='2'><hr class='ui-widget-content' style='margin:1px'/></td></tr><tr id='Act_Buttons'><td class='navButton' width='"+b.labelswidth+"'>"+(c?A+u:u+A)+"</td><td class='EditButton'>"+G+"</td></tr></tbody></table>");a.jgrid.createModal(o,p,b,"#gview_"+y.p.id,a("#gview_"+y.p.id)[0]);if(c){a("#pData, #nData","#"+
